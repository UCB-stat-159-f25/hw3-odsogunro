...
def make_plots_for_psd(det, strain_H1_whitenbp, template_match, time, timemax, SNR, DIR_FIGURES, eventname, plottype, tevent, template_fft, datafreq, d_eff, freqs, data_psd, fs, strain_L1_whitenbp, make_plots=1):
    if make_plots:
        ...
        plt.savefig(DIR_FIGURES / f"{eventname}_{det}_SNR.{plottype}") 
        ...
        plt.savefig(DIR_FIGURES / f"{eventname}_{det}_matchtime.{plottype}") 
        ...
        plt.savefig(DIR_FIGURES / f"{eventname}_{det}_matchfreq.{plottype}")       
